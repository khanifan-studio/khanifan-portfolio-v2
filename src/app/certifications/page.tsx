...
function Modal({ cert, onClose }: { cert: Certification; onClose: () => void }) {
    const accent = issuerAccent[cert.issuer] ?? {
        color: "#374151",
        dot: "#374151",
        border: "#e5e7eb",
            ...
            >
                ...
                <div
                    style={{
                        ...
                        aspectRatio: "4/3",
                        borderRadius: 14,
                        background: cert.image ? "#e5e7eb" : accent.bg,
                        border: `1px solid ${cert.image ? "rgba(255,255,255,0.9)" : accent.border}`,
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
                        marginBottom: 16,
                ...
                >
                    {cert.image ? (
                        ...
                        <span style={{ fontSize: 13, color: accent.color, fontWeight: 500, opacity: 0.6 }}>
                ...
                <FadeIn delay={0}>
                    <div style={{ marginBottom: "2.5rem" }}>
                        ...
                        <p style={{ fontSize: 13, color: "#9ca3af" }}>
                            {certifications.length} certifications — click any card to learn more
                        </p>
                    </div>
                </FadeIn>
                ...
                {[
                    {
                        ...
                        certs: awsCerts,
                        accent: issuerAccent["AWS Training & Certification"],
                    },
                    ...
                    <FadeIn key={group.issuer} delay={0.08 + gi * 0.06}>
                        <div style={{ marginBottom: "2.5rem" }}>
                            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 14 }}>
                                <span
                                    style={{ width: 7, height: 7, borderRadius: "50%", background: group.accent.dot }}
                                />
                                <p style={{ fontSize: 13, fontWeight: 600, color: group.accent.color, margin: 0 }}>
                                    {group.issuer}
                                </p>
                                    ...
                                    <FadeIn key={cert.id} delay={0.04 + i * 0.03}>
                                        <button
                                            ...
                                            onMouseEnter={e => {
                                                ...
                                                el.style.boxShadow =
                                                    "0 8px 24px rgba(99,102,241,0.12), 0 1px 0 rgba(255,255,255,0.9) inset";
                                                el.style.borderColor = group.accent.border;
                                            }}
                                            onMouseLeave={e => {
                                                const el = e.currentTarget as HTMLElement;
